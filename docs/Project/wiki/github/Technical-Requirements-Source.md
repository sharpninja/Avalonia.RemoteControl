...
- `TR-DOC-USER-001`: User documentation covers installation, server integration, client operation, local desktop quickstart, Android ADB desktop and CLI connection, embedded Codex MCP usage, security posture, settings, troubleshooting, and current published package version guidance.
