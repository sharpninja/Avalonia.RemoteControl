...
- [Getting started](Getting-Started) - local desktop quickstart.
- [Android ADB connections](Android-ADB) - emulator or connected-device quickstart.
- [Codex MCP](Codex-MCP) - launch Codex inside the tool and drive the connected app through MCP.
- [Client tool](Client-Tool) - desktop UI, docking, logs, live view, projects, and CLI workflows.
