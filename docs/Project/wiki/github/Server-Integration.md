...
See [Settings Guide](Settings-Guide) for the full explanation of defaults, recommended profiles, security tradeoffs, client fields, ADB flags, and common misconfigurations.
